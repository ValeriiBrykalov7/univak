...
const missionItems = [
  "професійно виконувати завдання клієнтів і партнерів;",
        ...
        <div className={styles.intro}>
          <div className={styles.header}>
            ...
            <div className={styles.lead}>
              <p>
                ТОВ «ЮНІВАК УКРАЇНА» розпочало господарську та дистриб’юторську
                діяльність в Україні у січні 2018 року.
              </p>
              <p>
                Основний напрям діяльності компанії — імпорт пакувальних
                матеріалів в Україну та їх постачання українським виробникам
                харчової продукції в молочній і м’ясній промисловості.
              </p>
              <p>
                Ми працюємо з підприємствами як сервісний партнер: консультуємо,
                підтримуємо й допомагаємо підбирати рішення для стабільного
                виробничого процесу.
              </p>
            </div>
          </div>
        ...
        <div className={styles.mission}>
          <div>
            ...
            <h3 className={styles.missionTitle}>
              Допомагати виробникам працювати стабільно, економно й упевнено.
            </h3>
          </div>
