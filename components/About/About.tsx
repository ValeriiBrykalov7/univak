...
const focusAreas = [
  {
    title: "Що постачаємо",
    description:
      "Імпортуємо термозбіжні пакети та рукави для пакування та дозрівання сиру, м’ясної продукції, птиці та риби. Також пропонуємо термозбіжні плівки та рукави, верхні плівки (ламінати) для застосування на термоформажному (THF) обладнанні та на машинах для пакування з готовими лотками (LID), ламінати для застосування FlowPack, верхні плівки для Skin та інші рішення",
  },
  {
